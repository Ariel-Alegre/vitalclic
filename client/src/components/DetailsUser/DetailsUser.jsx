...
const HealthProfessionalInfo = () => {
  ...
  function calcularEdad(fechaNacimiento) {
    ...
    // Si no ha cumplido años este año, resta 1
  ...
  // Uso
  const fechaNacimiento = "2017-02-24T03:00:00.000Z";
    ...
    >
      <Grid item xs={12} sm={10} md={8} lg={6}>
        <Paper elevation={3} sx={{ padding: 3 }}>
         ...
         {professional?.dependents.length > 0 ? (

           <Typography variant="body1" color="text.secondary" align="center" >
            <strong>Dependientes:</strong> {professional?.dependents.map((data) => (
              <div className={styles.textdependents}>
                <p>
                Nombres: {data.name} {data.lastName}, 
                </p>
                <p>
               Género: {data.genre}, 
                </p> 
